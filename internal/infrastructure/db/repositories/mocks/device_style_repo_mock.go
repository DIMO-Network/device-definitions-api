...
//
//	mockgen -source device_style_repo.go -destination mocks/device_style_repo_mock.go -package mocks
//
...
func (mr *MockDeviceStyleRepositoryMockRecorder) Create(ctx, deviceDefinitionID, name, externalStyleID, source, subModel, templateID any) *gomock.Call {
