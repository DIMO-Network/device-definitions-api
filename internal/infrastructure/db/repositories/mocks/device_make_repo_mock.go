...
//
//	mockgen -source device_make_repo.go -destination mocks/device_make_repo_mock.go -package mocks
//
...
func (mr *MockDeviceMakeRepositoryMockRecorder) GetAll(ctx any) *gomock.Call {
...
func (m *MockDeviceMakeRepository) GetBySlug(ctx context.Context, slug string) (*models.DeviceMake, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceMakeRepositoryMockRecorder) GetBySlug(ctx, slug any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBySlug", reflect.TypeOf((*MockDeviceMakeRepository)(nil).GetBySlug), ctx, slug)
}
...
func (m *MockDeviceMakeRepository) GetOrCreate(ctx context.Context, makeName, logURL, externalIDs, metadata, hardwareTemplateID string) (*models.DeviceMake, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrCreate", ctx, makeName, logURL, externalIDs, metadata, hardwareTemplateID)
	ret0, _ := ret[0].(*models.DeviceMake)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDeviceMakeRepositoryMockRecorder) GetOrCreate(ctx, makeName, logURL, externalIDs, metadata, hardwareTemplateID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrCreate", reflect.TypeOf((*MockDeviceMakeRepository)(nil).GetOrCreate), ctx, makeName, logURL, externalIDs, metadata, hardwareTemplateID)
}
