...
(
    ...
    device_definition_id character(27) COLLATE pg_catalog."default" NULL,
    ...
    data_bgman date NULL,
    data_endman date NULL,
    data_rcltypecd character varying(4) COLLATE pg_catalog."default" NOT NULL,
    data_potaff integer NULL,
    data_odate date NULL,
