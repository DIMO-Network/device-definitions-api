...
var file_pkg_grpc_device_definition_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x64, 0x32, 0xf3, 0x17, 0x0a, 0x17, 0x44, 0x65, 0x76, 0x69,
	...
	0x65, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x39, 0x5a,
...
var file_pkg_grpc_device_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_pkg_grpc_device_definition_proto_goTypes = []interface{}{
	...
	(*Integration_AutoPiPowertrainTemplate)(nil),                   // 56: grpc.Integration.AutoPiPowertrainTemplate
	(*UpdateDeviceDefinitionRequest_DeviceStyles)(nil),             // 57: grpc.UpdateDeviceDefinitionRequest.DeviceStyles
	(*UpdateDeviceDefinitionRequest_DeviceIntegrations)(nil),       // 58: grpc.UpdateDeviceDefinitionRequest.DeviceIntegrations
	(*GetDeviceDefinitionAllItemResponse_GetDeviceModels)(nil),     // 59: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels
	(*GetDeviceDefinitionAllItemResponse_GetDeviceModelYears)(nil), // 60: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModelYears
...
var file_pkg_grpc_device_definition_proto_depIdxs = []int32{
	...
	56, // 12: grpc.Integration.auto_pi_powertrain_template:type_name -> grpc.Integration.AutoPiPowertrainTemplate
	...
	57, // 18: grpc.UpdateDeviceDefinitionRequest.device_styles:type_name -> grpc.UpdateDeviceDefinitionRequest.DeviceStyles
	58, // 19: grpc.UpdateDeviceDefinitionRequest.device_integrations:type_name -> grpc.UpdateDeviceDefinitionRequest.DeviceIntegrations
	...
	59, // 23: grpc.GetDeviceDefinitionAllItemResponse.models:type_name -> grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels
	...
	61, // 31: grpc.UpdateDeviceDefinitionRequest.DeviceStyles.created_at:type_name -> google.protobuf.Timestamp
	61, // 32: grpc.UpdateDeviceDefinitionRequest.DeviceStyles.updated_at:type_name -> google.protobuf.Timestamp
	61, // 33: grpc.UpdateDeviceDefinitionRequest.DeviceIntegrations.created_at:type_name -> google.protobuf.Timestamp
	61, // 34: grpc.UpdateDeviceDefinitionRequest.DeviceIntegrations.updated_at:type_name -> google.protobuf.Timestamp
	19, // 35: grpc.UpdateDeviceDefinitionRequest.DeviceIntegrations.features:type_name -> grpc.DeviceIntegrationFeature
	60, // 36: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels.years:type_name -> grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModelYears
	...
	62, // 39: grpc.DeviceDefinitionService.GetDeviceDefinitions:input_type -> google.protobuf.Empty
	62, // 40: grpc.DeviceDefinitionService.GetDevicesMMY:input_type -> google.protobuf.Empty
	14, // 41: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:input_type -> grpc.GetDeviceDefinitionByMMYRequest
	15, // 42: grpc.DeviceDefinitionService.GetDeviceDefinitionBySource:input_type -> grpc.GetDeviceDefinitionBySourceRequest
	62, // 43: grpc.DeviceDefinitionService.GetDeviceDefinitionWithoutImages:input_type -> google.protobuf.Empty
	62, // 44: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:input_type -> google.protobuf.Empty
	40, // 45: grpc.DeviceDefinitionService.GetDeviceMakeByName:input_type -> grpc.GetDeviceMakeByNameRequest
	41, // 46: grpc.DeviceDefinitionService.GetDeviceMakeBySlug:input_type -> grpc.GetDeviceMakeBySlugRequest
	53, // 47: grpc.DeviceDefinitionService.GetDeviceMakeByTokenID:input_type -> grpc.GetDeviceMakeByTokenIdRequest
	62, // 48: grpc.DeviceDefinitionService.GetDeviceMakes:input_type -> google.protobuf.Empty
	62, // 49: grpc.DeviceDefinitionService.GetIntegrations:input_type -> google.protobuf.Empty
	34, // 50: grpc.DeviceDefinitionService.GetIntegrationByID:input_type -> grpc.GetIntegrationRequest
	21, // 51: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:input_type -> grpc.GetDeviceDefinitionIntegrationRequest
	22, // 52: grpc.DeviceDefinitionService.CreateDeviceDefinition:input_type -> grpc.CreateDeviceDefinitionRequest
	23, // 53: grpc.DeviceDefinitionService.CreateDeviceIntegration:input_type -> grpc.CreateDeviceIntegrationRequest
	33, // 54: grpc.DeviceDefinitionService.CreateDeviceStyle:input_type -> grpc.CreateDeviceStyleRequest
	35, // 55: grpc.DeviceDefinitionService.CreateDeviceMake:input_type -> grpc.CreateDeviceMakeRequest
	39, // 56: grpc.DeviceDefinitionService.CreateIntegration:input_type -> grpc.CreateIntegrationRequest
	26, // 57: grpc.DeviceDefinitionService.UpdateDeviceDefinition:input_type -> grpc.UpdateDeviceDefinitionRequest
	27, // 58: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:input_type -> grpc.UpdateDeviceDefinitionImageRequest
	30, // 59: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:input_type -> grpc.FilterDeviceDefinitionRequest
	36, // 60: grpc.DeviceDefinitionService.GetDeviceStyleByID:input_type -> grpc.GetDeviceStyleByIDRequest
	36, // 61: grpc.DeviceDefinitionService.GetDeviceStyleByExternalID:input_type -> grpc.GetDeviceStyleByIDRequest
	37, // 62: grpc.DeviceDefinitionService.GetDeviceStylesByDeviceDefinitionID:input_type -> grpc.GetDeviceStyleByDeviceDefinitionIDRequest
	45, // 63: grpc.DeviceDefinitionService.GetDeviceStylesByFilter:input_type -> grpc.GetDeviceStyleFilterRequest
	43, // 64: grpc.DeviceDefinitionService.UpdateDeviceMake:input_type -> grpc.UpdateDeviceMakeRequest
	44, // 65: grpc.DeviceDefinitionService.UpdateDeviceStyle:input_type -> grpc.UpdateDeviceStyleRequest
	46, // 66: grpc.DeviceDefinitionService.GetDeviceTypesByID:input_type -> grpc.GetDeviceTypeByIDRequest
	62, // 67: grpc.DeviceDefinitionService.GetDeviceTypes:input_type -> google.protobuf.Empty
	49, // 68: grpc.DeviceDefinitionService.CreateDeviceType:input_type -> grpc.CreateDeviceTypeRequest
	50, // 69: grpc.DeviceDefinitionService.UpdateDeviceType:input_type -> grpc.UpdateDeviceTypeRequest
	52, // 70: grpc.DeviceDefinitionService.DeleteDeviceType:input_type -> grpc.DeleteDeviceTypeRequest
	54, // 71: grpc.DeviceDefinitionService.GetDeviceDefinitionHardwareTemplateByID:input_type -> grpc.GetDeviceDefinitionHardwareTemplateByIDRequest
	2,  // 72: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:output_type -> grpc.GetDeviceDefinitionResponse
	3,  // 73: grpc.DeviceDefinitionService.GetDeviceDefinitionBySlug:output_type -> grpc.GetDeviceDefinitionItemResponse
	2,  // 74: grpc.DeviceDefinitionService.GetDeviceDefinitions:output_type -> grpc.GetDeviceDefinitionResponse
	4,  // 75: grpc.DeviceDefinitionService.GetDevicesMMY:output_type -> grpc.GetDevicesMMYResponse
	3,  // 76: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:output_type -> grpc.GetDeviceDefinitionItemResponse
	3,  // 77: grpc.DeviceDefinitionService.GetDeviceDefinitionBySource:output_type -> grpc.GetDeviceDefinitionItemResponse
	2,  // 78: grpc.DeviceDefinitionService.GetDeviceDefinitionWithoutImages:output_type -> grpc.GetDeviceDefinitionResponse
	28, // 79: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:output_type -> grpc.GetDeviceDefinitionAllResponse
	12, // 80: grpc.DeviceDefinitionService.GetDeviceMakeByName:output_type -> grpc.DeviceMake
	12, // 81: grpc.DeviceDefinitionService.GetDeviceMakeBySlug:output_type -> grpc.DeviceMake
	12, // 82: grpc.DeviceDefinitionService.GetDeviceMakeByTokenID:output_type -> grpc.DeviceMake
	42, // 83: grpc.DeviceDefinitionService.GetDeviceMakes:output_type -> grpc.GetDeviceMakeResponse
	16, // 84: grpc.DeviceDefinitionService.GetIntegrations:output_type -> grpc.GetIntegrationResponse
	17, // 85: grpc.DeviceDefinitionService.GetIntegrationByID:output_type -> grpc.Integration
	20, // 86: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:output_type -> grpc.GetDeviceDefinitionIntegrationResponse
	25, // 87: grpc.DeviceDefinitionService.CreateDeviceDefinition:output_type -> grpc.BaseResponse
	25, // 88: grpc.DeviceDefinitionService.CreateDeviceIntegration:output_type -> grpc.BaseResponse
	25, // 89: grpc.DeviceDefinitionService.CreateDeviceStyle:output_type -> grpc.BaseResponse
	25, // 90: grpc.DeviceDefinitionService.CreateDeviceMake:output_type -> grpc.BaseResponse
	25, // 91: grpc.DeviceDefinitionService.CreateIntegration:output_type -> grpc.BaseResponse
	25, // 92: grpc.DeviceDefinitionService.UpdateDeviceDefinition:output_type -> grpc.BaseResponse
	25, // 93: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:output_type -> grpc.BaseResponse
	31, // 94: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:output_type -> grpc.GetFilteredDeviceDefinitionsResponse
	11, // 95: grpc.DeviceDefinitionService.GetDeviceStyleByID:output_type -> grpc.DeviceStyle
	11, // 96: grpc.DeviceDefinitionService.GetDeviceStyleByExternalID:output_type -> grpc.DeviceStyle
	38, // 97: grpc.DeviceDefinitionService.GetDeviceStylesByDeviceDefinitionID:output_type -> grpc.GetDeviceStyleResponse
	38, // 98: grpc.DeviceDefinitionService.GetDeviceStylesByFilter:output_type -> grpc.GetDeviceStyleResponse
	25, // 99: grpc.DeviceDefinitionService.UpdateDeviceMake:output_type -> grpc.BaseResponse
	25, // 100: grpc.DeviceDefinitionService.UpdateDeviceStyle:output_type -> grpc.BaseResponse
	47, // 101: grpc.DeviceDefinitionService.GetDeviceTypesByID:output_type -> grpc.GetDeviceTypeResponse
	48, // 102: grpc.DeviceDefinitionService.GetDeviceTypes:output_type -> grpc.GetDeviceTypeListResponse
	25, // 103: grpc.DeviceDefinitionService.CreateDeviceType:output_type -> grpc.BaseResponse
	25, // 104: grpc.DeviceDefinitionService.UpdateDeviceType:output_type -> grpc.BaseResponse
	25, // 105: grpc.DeviceDefinitionService.DeleteDeviceType:output_type -> grpc.BaseResponse
	55, // 106: grpc.DeviceDefinitionService.GetDeviceDefinitionHardwareTemplateByID:output_type -> grpc.GetDeviceDefinitionHardwareTemplateByIDResponse
