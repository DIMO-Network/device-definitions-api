...
type GetIntegrationItemResponse struct {
	...
	AutoPiPowertrainToTemplateID int32  `protobuf:"varint,6,opt,name=auto_pi_powertrain_to_templateID,json=autoPiPowertrainToTemplateID,proto3" json:"auto_pi_powertrain_to_templateID,omitempty"`
}
...
func (x *GetIntegrationItemResponse) GetAutoPiPowertrainToTemplateID() int32 {
	if x != nil {
		return x.AutoPiPowertrainToTemplateID
	}
	return 0
}
...
var file_pkg_grpc_device_definition_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf4, 0x01, 0x0a, 0x1a, 0x47, 0x65,
	...
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12, 0x46, 0x0a, 0x20, 0x61, 0x75, 0x74, 0x6f,
	0x5f, 0x70, 0x69, 0x5f, 0x70, 0x6f, 0x77, 0x65, 0x72, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x74,
	0x6f, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x44, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x1c, 0x61, 0x75, 0x74, 0x6f, 0x50, 0x69, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x74,
	0x72, 0x61, 0x69, 0x6e, 0x54, 0x6f, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x44,
	...
	0x61, 0x6b, 0x65, 0x32, 0x87, 0x08, 0x0a, 0x17, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x65,
...
var file_pkg_grpc_device_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_pkg_grpc_device_definition_proto_goTypes = []interface{}{
	...
	(*GetDeviceDefinitionAllItemResponse_GetDeviceModels)(nil),     // 27: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels
	(*GetDeviceDefinitionAllItemResponse_GetDeviceModelYears)(nil), // 28: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModelYears
}
var file_pkg_grpc_device_definition_proto_depIdxs = []int32{
	...
	19, // 9: grpc.GetDeviceDefinitionAllResponse.items:type_name -> grpc.GetDeviceDefinitionAllItemResponse
	27, // 10: grpc.GetDeviceDefinitionAllItemResponse.models:type_name -> grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels
	22, // 11: grpc.GetFilteredDeviceDefinitionsResponse.Items:type_name -> grpc.FilterDeviceDefinitionsReponse
	28, // 12: grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModels.years:type_name -> grpc.GetDeviceDefinitionAllItemResponse.GetDeviceModelYears
	0,  // 13: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:input_type -> grpc.GetDeviceDefinitionRequest
	4,  // 14: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:input_type -> grpc.GetDeviceDefinitionByMMYRequest
	6,  // 15: grpc.DeviceDefinitionService.GetIntegrations:input_type -> grpc.EmptyRequest
	10, // 16: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:input_type -> grpc.GetDeviceDefinitionIntegrationRequest
	11, // 17: grpc.DeviceDefinitionService.CreateDeviceDefinition:input_type -> grpc.CreateDeviceDefinitionRequest
	13, // 18: grpc.DeviceDefinitionService.CreateDeviceIntegration:input_type -> grpc.CreateDeviceIntegrationRequest
	15, // 19: grpc.DeviceDefinitionService.UpdateDeviceDefinition:input_type -> grpc.UpdateDeviceDefinitionRequest
	17, // 20: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:input_type -> grpc.UpdateDeviceDefinitionImageRequest
	6,  // 21: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:input_type -> grpc.EmptyRequest
	20, // 22: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:input_type -> grpc.FilterDeviceDefinitionRequest
	1,  // 23: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:output_type -> grpc.GetDeviceDefinitionResponse
	2,  // 24: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:output_type -> grpc.GetDeviceDefinitionItemResponse
	5,  // 25: grpc.DeviceDefinitionService.GetIntegrations:output_type -> grpc.GetIntegrationResponse
	8,  // 26: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:output_type -> grpc.GetDeviceDefinitionIntegrationResponse
	12, // 27: grpc.DeviceDefinitionService.CreateDeviceDefinition:output_type -> grpc.CreateDeviceDefinitionResponse
	14, // 28: grpc.DeviceDefinitionService.CreateDeviceIntegration:output_type -> grpc.CreateDeviceIntegrationResponse
	16, // 29: grpc.DeviceDefinitionService.UpdateDeviceDefinition:output_type -> grpc.UpdateDeviceDefinitionResponse
	16, // 30: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:output_type -> grpc.UpdateDeviceDefinitionResponse
	18, // 31: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:output_type -> grpc.GetDeviceDefinitionAllResponse
	21, // 32: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:output_type -> grpc.GetFilteredDeviceDefinitionsResponse
