...
var file_pkg_grpc_device_definition_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x9c, 0x09, 0x0a, 0x17, 0x44,
...
var file_pkg_grpc_device_definition_proto_depIdxs = []int32{
	...
	32, // 23: grpc.DeviceDefinitionService.GetIntegrations:input_type -> google.protobuf.Empty
	...
	32, // 32: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:input_type -> google.protobuf.Empty
	20, // 33: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:input_type -> grpc.FilterDeviceDefinitionRequest
	1,  // 34: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:output_type -> grpc.GetDeviceDefinitionResponse
	2,  // 35: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:output_type -> grpc.GetDeviceDefinitionItemResponse
	8,  // 36: grpc.DeviceDefinitionService.GetIntegrations:output_type -> grpc.GetIntegrationResponse
	9,  // 37: grpc.DeviceDefinitionService.GetIntegrationByID:output_type -> grpc.Integration
	11, // 38: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:output_type -> grpc.GetDeviceDefinitionIntegrationResponse
	15, // 39: grpc.DeviceDefinitionService.CreateDeviceDefinition:output_type -> grpc.BaseResponse
	15, // 40: grpc.DeviceDefinitionService.CreateDeviceIntegration:output_type -> grpc.BaseResponse
	15, // 41: grpc.DeviceDefinitionService.CreateDeviceStyle:output_type -> grpc.BaseResponse
	15, // 42: grpc.DeviceDefinitionService.CreateDeviceMake:output_type -> grpc.BaseResponse
	15, // 43: grpc.DeviceDefinitionService.UpdateDeviceDefinition:output_type -> grpc.BaseResponse
	15, // 44: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:output_type -> grpc.BaseResponse
	18, // 45: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:output_type -> grpc.GetDeviceDefinitionAllResponse
	21, // 46: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:output_type -> grpc.GetFilteredDeviceDefinitionsResponse
