...
var file_pkg_grpc_device_definition_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xd5, 0x08, 0x0a, 0x17,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e,
...
var file_pkg_grpc_device_definition_proto_depIdxs = []int32{
	...
	31, // 23: grpc.DeviceDefinitionService.GetIntegrations:input_type -> google.protobuf.Empty
	...
	16, // 29: grpc.DeviceDefinitionService.UpdateDeviceDefinition:input_type -> grpc.UpdateDeviceDefinitionRequest
	17, // 30: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:input_type -> grpc.UpdateDeviceDefinitionImageRequest
	31, // 31: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:input_type -> google.protobuf.Empty
	20, // 32: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:input_type -> grpc.FilterDeviceDefinitionRequest
	1,  // 33: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:output_type -> grpc.GetDeviceDefinitionResponse
	2,  // 34: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:output_type -> grpc.GetDeviceDefinitionItemResponse
	8,  // 35: grpc.DeviceDefinitionService.GetIntegrations:output_type -> grpc.GetIntegrationResponse
	9,  // 36: grpc.DeviceDefinitionService.GetIntegrationByID:output_type -> grpc.Integration
	11, // 37: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:output_type -> grpc.GetDeviceDefinitionIntegrationResponse
	15, // 38: grpc.DeviceDefinitionService.CreateDeviceDefinition:output_type -> grpc.BaseResponse
	15, // 39: grpc.DeviceDefinitionService.CreateDeviceIntegration:output_type -> grpc.BaseResponse
	15, // 40: grpc.DeviceDefinitionService.CreateDeviceStyle:output_type -> grpc.BaseResponse
	15, // 41: grpc.DeviceDefinitionService.UpdateDeviceDefinition:output_type -> grpc.BaseResponse
	15, // 42: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:output_type -> grpc.BaseResponse
	18, // 43: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:output_type -> grpc.GetDeviceDefinitionAllResponse
	21, // 44: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:output_type -> grpc.GetFilteredDeviceDefinitionsResponse
