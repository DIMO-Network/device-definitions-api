...
var file_pkg_grpc_device_definition_proto_rawDesc = []byte{
	...
	0x79, 0x6c, 0x65, 0x32, 0xe3, 0x0c, 0x0a, 0x17, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x65,
	...
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6a, 0x0a, 0x1b, 0x47, 0x65, 0x74,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e,
...
var file_pkg_grpc_device_definition_proto_depIdxs = []int32{
	...
	7,  // 23: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:input_type -> grpc.GetDeviceDefinitionByMMYRequest
	8,  // 24: grpc.DeviceDefinitionService.GetDeviceDefinitionBySource:input_type -> grpc.GetDeviceDefinitionBySourceRequest
	37, // 25: grpc.DeviceDefinitionService.GetIntegrations:input_type -> google.protobuf.Empty
	25, // 26: grpc.DeviceDefinitionService.GetIntegrationByID:input_type -> grpc.GetIntegrationRequest
	13, // 27: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:input_type -> grpc.GetDeviceDefinitionIntegrationRequest
	14, // 28: grpc.DeviceDefinitionService.CreateDeviceDefinition:input_type -> grpc.CreateDeviceDefinitionRequest
	15, // 29: grpc.DeviceDefinitionService.CreateDeviceIntegration:input_type -> grpc.CreateDeviceIntegrationRequest
	24, // 30: grpc.DeviceDefinitionService.CreateDeviceStyle:input_type -> grpc.CreateDeviceStyleRequest
	26, // 31: grpc.DeviceDefinitionService.CreateDeviceMake:input_type -> grpc.CreateDeviceMakeRequest
	30, // 32: grpc.DeviceDefinitionService.CreateIntegration:input_type -> grpc.CreateIntegrationRequest
	17, // 33: grpc.DeviceDefinitionService.UpdateDeviceDefinition:input_type -> grpc.UpdateDeviceDefinitionRequest
	18, // 34: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:input_type -> grpc.UpdateDeviceDefinitionImageRequest
	37, // 35: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:input_type -> google.protobuf.Empty
	21, // 36: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:input_type -> grpc.FilterDeviceDefinitionRequest
	27, // 37: grpc.DeviceDefinitionService.GetDeviceStyleByID:input_type -> grpc.GetDeviceStyleByIDRequest
	27, // 38: grpc.DeviceDefinitionService.GetDeviceStyleByExternalID:input_type -> grpc.GetDeviceStyleByIDRequest
	28, // 39: grpc.DeviceDefinitionService.GetDeviceStylesByDeviceDefinitionID:input_type -> grpc.GetDeviceStyleByDeviceDefinitionIDRequest
	1,  // 40: grpc.DeviceDefinitionService.GetDeviceDefinitionByID:output_type -> grpc.GetDeviceDefinitionResponse
	2,  // 41: grpc.DeviceDefinitionService.GetDeviceDefinitionByMMY:output_type -> grpc.GetDeviceDefinitionItemResponse
	1,  // 42: grpc.DeviceDefinitionService.GetDeviceDefinitionBySource:output_type -> grpc.GetDeviceDefinitionResponse
	9,  // 43: grpc.DeviceDefinitionService.GetIntegrations:output_type -> grpc.GetIntegrationResponse
	10, // 44: grpc.DeviceDefinitionService.GetIntegrationByID:output_type -> grpc.Integration
	12, // 45: grpc.DeviceDefinitionService.GetDeviceDefinitionIntegration:output_type -> grpc.GetDeviceDefinitionIntegrationResponse
	16, // 46: grpc.DeviceDefinitionService.CreateDeviceDefinition:output_type -> grpc.BaseResponse
	16, // 47: grpc.DeviceDefinitionService.CreateDeviceIntegration:output_type -> grpc.BaseResponse
	16, // 48: grpc.DeviceDefinitionService.CreateDeviceStyle:output_type -> grpc.BaseResponse
	16, // 49: grpc.DeviceDefinitionService.CreateDeviceMake:output_type -> grpc.BaseResponse
	16, // 50: grpc.DeviceDefinitionService.CreateIntegration:output_type -> grpc.BaseResponse
	16, // 51: grpc.DeviceDefinitionService.UpdateDeviceDefinition:output_type -> grpc.BaseResponse
	16, // 52: grpc.DeviceDefinitionService.SetDeviceDefinitionImage:output_type -> grpc.BaseResponse
	19, // 53: grpc.DeviceDefinitionService.GetDeviceDefinitionAll:output_type -> grpc.GetDeviceDefinitionAllResponse
	22, // 54: grpc.DeviceDefinitionService.GetFilteredDeviceDefinition:output_type -> grpc.GetFilteredDeviceDefinitionsResponse
	4,  // 55: grpc.DeviceDefinitionService.GetDeviceStyleByID:output_type -> grpc.DeviceStyle
	4,  // 56: grpc.DeviceDefinitionService.GetDeviceStyleByExternalID:output_type -> grpc.DeviceStyle
	29, // 57: grpc.DeviceDefinitionService.GetDeviceStylesByDeviceDefinitionID:output_type -> grpc.GetDeviceStyleResponse
