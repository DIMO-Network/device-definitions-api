...
type GetReviewsByModelRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetReviewsByModelRequest) Reset() {
	*x = GetReviewsByModelRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetReviewsByModelRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReviewsByModelRequest) ProtoMessage() {}

func (x *GetReviewsByModelRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_grpc_reviews_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReviewsByModelRequest.ProtoReflect.Descriptor instead.
func (*GetReviewsByModelRequest) Descriptor() ([]byte, []int) {
	return file_pkg_grpc_reviews_proto_rawDescGZIP(), []int{1}
}

func (x *GetReviewsByModelRequest) GetDeviceDefinitionId() string {
	if x != nil {
		return x.DeviceDefinitionId
	}
	return ""
...
var file_pkg_grpc_reviews_proto_rawDesc = []byte{
	...
	0x77, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x88,
	...
	0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x4c, 0x0a, 0x18, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x73, 0x42, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x65,
	...
	,
...
var file_pkg_grpc_reviews_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_grpc_reviews_proto_goTypes = []interface{}{
	(*DeviceReview)(nil),             // 0: grpc.DeviceReview
	(*GetReviewsByModelRequest)(nil), // 1: grpc.GetReviewsByModelRequest
...
var file_pkg_grpc_reviews_proto_depIdxs = []int32{
	...
	1, // 1: grpc.ReviewsService.GetReviewsByModel:input_type -> grpc.GetReviewsByModelRequest
	2, // 2: grpc.ReviewsService.GetReviewsByModel:output_type -> grpc.GetReviewsResponse
...
func file_pkg_grpc_reviews_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_grpc_reviews_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetReviewsByModelRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
