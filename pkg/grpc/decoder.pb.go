...
type ChangeDecodingRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ChangeDecodingRequest) Reset() {
	*x = ChangeDecodingRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangeDecodingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeDecodingRequest) ProtoMessage() {}

func (x *ChangeDecodingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_grpc_decoder_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeDecodingRequest.ProtoReflect.Descriptor instead.
func (*ChangeDecodingRequest) Descriptor() ([]byte, []int) {
	return file_pkg_grpc_decoder_proto_rawDescGZIP(), []int{2}
}

func (x *ChangeDecodingRequest) GetVin() string {
	if x != nil {
		return x.Vin
	}
	return ""
...
func (x *ChangeDecodingRequest) GetTargetDefinitionId() string {
	if x != nil {
...
var file_pkg_grpc_decoder_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x59, 0x65, 0x61, 0x72, 0x22, 0xb2, 0x02, 0x0a, 0x11,
	...
	0x22, 0x5b, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x44, 0x65, 0x63, 0x6f, 0x64, 0x69,
	0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x76, 0x69, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x76, 0x69, 0x6e, 0x12, 0x30, 0x0a, 0x14, 0x74,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x32, 0x98, 0x01,
	...
	0x44, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x56, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x45, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x44, 0x65, 0x63, 0x6f, 0x64,
	0x69, 0x6e, 0x67, 0x12, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x44, 0x65, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
...
var file_pkg_grpc_decoder_proto_goTypes = []interface{}{
	...
	(*ChangeDecodingRequest)(nil), // 2: grpc.ChangeDecodingRequest
...
var file_pkg_grpc_decoder_proto_depIdxs = []int32{
	...
	2, // 1: grpc.VinDecoderService.ChangeDecoding:input_type -> grpc.ChangeDecodingRequest
...
func file_pkg_grpc_decoder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_grpc_decoder_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangeDecodingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
