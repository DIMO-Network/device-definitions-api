// Package docs Code generated by swaggo/swag at 2024-09-30 21:57:06.38933 -0400 EDT m=+1.661899793. DO NOT EDIT
package docs
    ...
    "paths": {
        ...
        "/device-definitions/decode-vin": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "response with definition ID. TODO return polygon transaction if new DD",
                        "schema": {
